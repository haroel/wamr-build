...
Assert-Contains 'cmake/wamr-runtime/CMakeLists.txt' 'WAMR_BUILD_LIB_PTHREAD 1'
Assert-Contains 'cmake/wamr-runtime/CMakeLists.txt' 'WAMR_BUILD_LIB_WASI_THREADS 1'
Assert-Contains 'cmake/wamr-runtime/CMakeLists.txt' 'WAMR_DISABLE_HW_BOUND_CHECK 1'
...
Assert-Contains '.github/workflows/release-apple.yml' 'apple*'
